...
> **状态（2026-08-05）**：Batch A 已生成，并迁入**独立地图** `capybara_rush/`（不进星火信使 `models/` / `runner_60s`）。  
> - 概念图：Elser → `_inbox/concepts/capybara_stack/`  
> - Tripo 原料：`_inbox/tripo_raw/capybara_stack/`  
> - 正式入库：`capybara_rush/models/`  
> - 复跑脚本：`_inbox/concepts/capybara_stack/GENERATE_WITH_TRIPO.sh`  
> Tripo 余额约消耗 300 credits（5×(50+10)），生成后余额约 60。
...
*文档版本：2026-08-05 · Batch A 已入库 capybara_rush*
