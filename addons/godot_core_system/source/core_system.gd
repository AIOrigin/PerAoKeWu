...
const LoggerModule = preload("./logger/logger.gd")
const ResourceManagerModule = preload("./resource_system/resource_manager.gd")
...
const ConfigManagerModule = preload("./config_system/config_manager.gd")
...
@onready var logger = _get_module("logger"):								## 日志管理器
	get:
		if not logger:
			logger = _get_module("logger")
		return logger
@onready var resource_manager = _get_module("resource_manager"):			## 资源管理器
	get:
...
@onready var config_manager = _get_module("config_manager"):			## 配置管理器
	get:
...
var _module_scripts: Dictionary[StringName, Script] = {
	...
	"logger": LoggerModule,
	"resource_manager": ResourceManagerModule,
	"scene_manager": SceneManager,
	"time_manager": TimeManager,
	"save_manager": SaveManager,
	"config_manager": ConfigManagerModule,
